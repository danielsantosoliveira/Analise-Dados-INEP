''' @author: Daniel e Everton
    Análise de dados INEP/ENAD: Evolução dos negros (Pretos e Pardos) ingressantes em Universidades Públicas(Federal, Estadual e Municipal) do Brasil;
...
for ano in anos:
    ...
    #contabilização e consolidação das inforamções - Geral
    ...
    #contabilização e consolidação das inforamções - Estadual
    ...
    #contabilização e consolidação das inforamções - Municipal
